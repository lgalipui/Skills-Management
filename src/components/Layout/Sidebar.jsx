...
export const Sidebar = () => {
  ...
  const navItems = [
    ...
    { path: '/mybadges', label: 'MyBadges', icon: Award, roles: ['Employee', 'Manager'] },
    { path: '/peer-nomination', label: 'Nominación de Peers', icon: UserCheck, roles: ['Employee', 'Manager'] },
    { path: '/skills-review', label: 'Skills Review', icon: Users, roles: ['Employee', 'Manager'] },
    { path: '/development-plans', label: 'Planes de Desarrollo', icon: FileText, roles: ['Employee', 'Manager'] },
